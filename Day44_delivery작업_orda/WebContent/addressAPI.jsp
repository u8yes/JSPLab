...
<input name="postAddr2" type="text" id="sample4_roadAddress" placeholder="도로명주소  + 상세주소" size="60" ><br>
<input type="hidden" id="sample4_jibunAddress" placeholder="지번주소"  size="60">
<span id="guide" style="color:#999;display:none"></span>
<input name="postAddr3" type="text" id="sample4_detailAddress" placeholder="상세주소"  size="60"><br>
